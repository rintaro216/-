                ...
                {isInLiff && liffProfile ? (
                  ...
                  <div className="space-y-3">
                    <p className="text-sm text-gray-700 mb-3">
                      予約完了・キャンセル・前日リマインダーをLINEで受け取れます
                    </p>
                    <button
                      type="button"
                      onClick={handleLineConnect}
                      disabled={isConnectingLine}
                      className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition font-bold disabled:bg-gray-300 disabled:cursor-not-allowed"
                    >
                    ...
                    <p className="text-xs text-gray-500 text-center">
                      ※ 連携しない場合はこのまま下の「予約を確定する」ボタンを押してください
                    </p>
                  </div>
                )}
              </div>
